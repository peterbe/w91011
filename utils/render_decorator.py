...
class render:
    ...
    class render_decorator:
        ...
        def __init__(self, parent, view_func, page_title=None, no_http_cache=False):
            self.parent = parent
            self.view_func = view_func
            self.page_title = page_title
            self.no_http_cache = no_http_cache
        ...
        def html_render(self, request, context, template):
            ...
            if 'page_title' in context:
                request.page_title = context['page_title']
    ...
    def __init__(self, template=None, format=None, page_title=None, no_http_cache=False):
    ...
    def __call__(self, view_func):
        return render.render_decorator(self, view_func,
                                       ...
                                       no_http_cache=self.no_http_cache)
